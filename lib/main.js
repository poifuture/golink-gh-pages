...
var resolveConfig = function () {
    if (!fs_1.default.existsSync(ConfigPath)) {
        var defaultConfigString = JSON.stringify(DefaultConfig, null, 2);
...
var initDocs = function (_a) {
    var _b = _a.fuzzy, fuzzy = _b === void 0 ? true : _b, _c = _a.unsafe, unsafe = _c === void 0 ? false : _c;
    if (!fs_1.default.existsSync("entries.json")) {
        fs_1.default.writeFileSync("entries.json", JSON.stringify({
    ...
    if (!fs_1.default.existsSync("docs/entry")) {
        ...
        fs_1.default.writeFileSync("docs/entry/google", "https://www.google.com");
    }
    var homeHtml = fs_1.default.readFileSync(__dirname + "/template.html", "utf8");
    if (fuzzy !== true) {
    ...
    fs_1.default.writeFileSync("docs/index.html", homeHtml);
};
var resolveRichEntries = function (_a) {
    var _b = _a.fuzzy, fuzzy = _b === void 0 ? true : _b;
    var entriesString = fs_1.default.existsSync("entries.json5")
        ? fs_1.default.readFileSync("entries.json5", "utf8")
        : fs_1.default.existsSync("entries.json")
            ? fs_1.default.readFileSync("entries.json", "utf8")
            : "";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                richEntries = resolveRichEntries({ fuzzy: config.fuzzy });
