...
var initRepo = function () {
    ...
    if (!fs_1.default.existsSync("entries.json")) {
        fs_1.default.writeFileSync("entries.json", json_stable_stringify_1.default({
            "golink-intro": "https://medium.com/@golinks/the-full-history-of-go-links-and-the-golink-system-cbc6d2c8bb3",
...
var initDocs = function (_a) {
    ...
    if (fs_1.default.existsSync("docs/CNAME")) {
        fs_1.default.copyFileSync("docs/CNAME", "CNAME");
    }
    if (cleanStart) {
    ...
    if (!fs_1.default.existsSync("docs")) {
        ...
        if (fs_1.default.existsSync("CNAME")) {
            fs_1.default.copyFileSync("CNAME", "docs/CNAME");
        }
    }
