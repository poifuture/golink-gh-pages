...
var prepare = function (golinkHost) {
    ...
    switch (process_1.default.platform) {
        case "win32": {
            ...
            fs_1.default.writeFileSync(path_1.default.join(process_1.default.env.APPDATA, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "golink-local.vbs"), startupWrapper);
            break;
        }
        case "linux": {
